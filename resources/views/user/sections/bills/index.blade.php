    ...
    <div class="modal-dialog modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form class="card-form" action="{{ setRoute('user.bills.airtime') }}" id="buyAirtime" method="POST">
                @csrf
                <div class="row">
...
<div class="modal fade" id="BuyDataModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form class="card-form" action="{{ setRoute('user.bills.data') }}" id="buyData" method="POST">
                @csrf
                <div class="row">
                    <div class="col-12 form-group">
                        <label class="form-label" for="network">Network  <span class="text--base">*</span></label>
...
<div class="modal fade" id="BuyCableModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form class="card-form" action="{{ setRoute('user.bills.cable') }}" id="buyData" method="POST">
                @csrf
                <div class="row">
                    <div class="col-12 form-group">
...
<div class="modal fade" id="BuyPowerModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form class="card-form" action="{{ setRoute('user.bills.power') }}" id="buyAirtime" method="POST">
                @csrf
                <div class="row">
                    <div class="col-12 form-group">
