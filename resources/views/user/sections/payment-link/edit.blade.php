                                    ...
                                    <select class="select2-auto-tokenize currency_link" name="currency">
                                        ...
                                        @foreach ($currency_data as $item)
                                            @isset($item->currency_code)
                                                <option value="{{ $item->currency_code }}" {{ $payment_link->currency == $item->currency_code ? 'selected' : '' }}  data-currency_name="{{ $item->currency_name }}" data-currency_code="{{ $item->currency_code }}" data-currency_symbol="{{ $item->currency_symbol }}">{{ $item->currency_code.' - '.$item->currency_name }}</option>
                                            @endisset
                                        @endforeach
                                    </select>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12 form-group">
                                ...
                                <select class="select2-auto-tokenize currency_link_sub" name="sub_currency">
                                    ...
                                    @foreach ($currency_data as $item)
                                        @isset($item->currency_code)
                                            <option value="{{ $item->currency_code }}" {{ $payment_link->currency == $item->currency_code ? 'selected' : '' }} data-currency_code="{{ $item->currency_code }}" data-currency_symbol="{{ $item->currency_symbol }}" data-currency_name="{{ $item->currency_name }}" data-currency_code="{{ $item->currency_code }}" data-currency_symbol="{{ $item->currency_symbol }}">{{ $item->currency_code.' - '.$item->currency_name }}</option>
                                        @endisset
                                    @endforeach
                                </select>
                            </div>
