...
<div class="body-wrapper">
            ...
            <div class="dash-payment-item-wrapper">
                <div class="dash-payment-item active">
                    <div class="dash-payment-title-area">
                        ...
                        <h5 class="title">NFC Withdraw</h5>
                    </div>
                        ...
                        <form class="card-form" action="{{ setRoute('user.send.money.confirmed') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xxl-6 col-xl-12 col-lg-6 form-group paste-wrapper">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-texthk copytext"> </span>
                                        </div>
                                          </div>
                                ...
                                <div class="col-xl-12 col-lg-12">
                                    <button type="button"  class="paste-badge scan"class="btn--base w-100 btn-loading transfer">{{ __("Card Scan") }} <i class="fas fa-paper-plane ms-1"></i></i></button>
                                </div>
                            </div>
                        </form>
                    </div>
        ...
        <div class="col-xl-6 mb-30">
            <div class="dash-payment-item-wrapper">
                <div class="dash-payment-item active">
                    <div class="dash-payment-title-area">
                        <span class="dash-payment-badge">!</span>
                        <h5 class="title">{{__("How NFC Work ")}}</h5>
                    </div>
                    <div class="dash-payment-body">
                    <div class="preview-list-wrapper">
                <div class="sidebar-doc-box bg_img" data-background="{{ asset('public/frontend/') }}/images/element/nfc.gif">
            <div class="sidebar-doc-icjon">
          </div>
    ...
    <div class="dashboard-list-area mt-20">
        <div class="dashboard-header-wrapper">
            <h4 class="title ">{{__("NFC Payment Log")}}</h4>
