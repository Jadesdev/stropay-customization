...
class AuthenticationController extends Controller
{
    ...
    public function generateToken(Request $request) {
        $validator = Validator::make($request->all(),[
            'client_id'     => "required|string|size:100|exists:developer_api_credentials",
            'secret_id'     => "required|string|size:100|exists:developer_api_credentials,client_secret",
        ],[
            'client_id.size'    => "Invalid client ID",
            'secret_id.size'    => "Invalid secret ID",
        ]);
